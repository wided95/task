  ...
  return (
    <section class=" relative rounded-lg w-full h-full upload-file-container flex items-center justify-center gap-3 flex-col">
      <input
        ...
        type="file"
      />
      <ArchiveBoxArrowDownIcon className="lg:h-[4vw] sm:h-[8vw] h-[10vw] w-[10vw] sm:w-[8vw] md:h-[5vw] lg:w-[4vw] md:w-[5vw] cursor-pointer rotate-180 rounded-full p-2 border-2 border-solid border-black " />
